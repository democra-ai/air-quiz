...
// the library the guesser uses. Validated independently: scripts/validate-bls-all.mjs
// covers ALL 96 occupations (one fresh respondent each) at 100% top-3 / 90.6%
// top-1, and scripts/validate-bls-independent.mjs covers 50 common professions at
// 100% top-3 / 86% top-1. The hand-curated OCCUPATION_PATTERNS below are kept only
// for the tune-occupation.mjs dev harness.
