...
// Comprehensive occupation library (160 jobs across all 23 SOC major groups: the
// 96 PROFILE_CAREERS occupations + 64 common supplementary jobs people self-
// identify as), generated by scripts/gen-occupations.mjs from hand-authored
// REALISTIC answer vectors (scripts/realistic-answers.mjs) — each anchored where a
// real worker's answers actually land, with its archetype COMPUTED from that
// vector. This is the library the guesser uses. Validated independently: the 96
// PROFILE jobs (validate-bls-all.mjs) and 64 supplementary jobs
// (validate-supplementary.mjs) both hit 100% top-3 (160/160 combined). The
// hand-curated OCCUPATION_PATTERNS below are kept only for tune-occupation.mjs.
