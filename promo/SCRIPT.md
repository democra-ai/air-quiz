...
> 由 `workflows/script-storyboard.mjs` 工作流产出（调研→3稿→评审→合成→人味润色）。配音/BGM 走 `ai-video-studio` 管线（src/script.json → edge-tts 女声 → 时长测量；BGM = Carefree）。
> **改这份文件或直接告诉我改动**；改文案后跑 `node scripts/prepare.mjs` 重算时长。三层：分镜=画面 · 字幕=烧录文字 · 配音=女声口播。
...
- **字幕 ZH:** MBTI 你都测过了
那你的「AI 职业人格」呢？
- **配音 EN:** You know your MBTI. But what's your AI-resistance type? Same idea — it tells you how much of your job AI just can't touch.
- **配音 ZH:** MBTI 你早测过了。那你的「AI 职业人格」呢？玩法一样，测的是：你的饭碗，AI 到底动得了几分。

## ② 16 型类比 / 眼球钩子 — `grid-float`
...
每一型，都是一种「守得住」的活法
- **配音 EN:** MBTI sorts you into sixteen personalities. We sort you into sixteen career archetypes — and every one is its own way to hold the line against AI.
- **配音 ZH:** MBTI 把你分成十六种人格，我们把你分成十六种职业原型——每一型，都是你在 AI 浪潮里站得住脚的一种活法。

## ③ 四维度拆解 / 守住 vs 拿走 — `axes-anim`
...
- **字幕 ZH:** 学得会吗？打得了分吗？
敢替你冒险吗？非你不可吗？
- **配音 EN:** It comes down to four questions. Can AI learn it? Can AI grade it? Will AI take the risk? Do they need you in the room? Four answers — sixteen ways to hold the line.
- **配音 ZH:** 说白了就四个问题：AI 学得会吗？打得了分吗？敢替你冒险吗？离了你行不行？四个答案，拼出十六种活法。
...
- **字幕 EN:** 16 questions · ~3 min
60 questions · ~12 min · free
- **字幕 ZH:** 16 题 · 约 3 分钟
60 题 · 约 12 分钟 · 免费
- **配音 EN:** There are two versions. The quick one is sixteen questions, about three minutes. Want it sharper? Sixty questions, about twelve. Both free, no sign-up.
- **配音 ZH:** 有两个版本。想快，十六道题，三分钟搞定；想更准，六十道题，大概十二分钟。都免费，不用注册。

## ⑤ 结果示范 / 研究人员=高压炼金师 — `result-real`
...
剩下的，是你的。
- **配音 EN:** I took it myself and came out ESRP — the Pressure Alchemist. Low risk: only about twenty-nine percent is AI's to take. The rest stays mine. Because when failure isn't an option, you call a human.
- **配音 ZH:** 我自己测了一下，是 E S R P，高压炼金师。低风险，只有大约三成会被 AI 接手，剩下的，都是我的。因为一旦不许出错，还是得找个活人来兜底。

## ⑥ 你是哪一种 / 转发钩子 — `which-pivot`
...
- **配音 ZH:** 去 air democra ai 测出你是哪一种，一分钟，免费。测完发给那个你私下觉得最先被 AI 盯上的同事，看他敢不敢点开。放心，我不说。
